...
export const BIO = (
  <p className="text-justify m-0 pt-2.5">
    Sudharshan Suresh (he/him) is a senior staff research scientist at Boston Dynamics, working on machine learning for the Atlas humanoid robot. He earned a Ph.D. from the Robotics Institute at Carnegie Mellon University, working on touch, dexterity, and robot learning. He was also a visiting researcher at FAIR (Meta), working with the dexterous manipulation team. His thesis enabled robots to learn from vision and touch, see popular work like NeuralFeels and MidasTouch. Prior to this, he completed his Masters in Robotics at CMU, working on field robotics and underwater exploration. His work in manipulation, perception, and SLAM has been presented at Science Robotics, CoRL, ICRA, IROS, and RA-L. Sudharshan is the recipient of the Hima and Jive Fellowship in Computer Science and the best paper finalist in service robotics at ICRA 2021.
  </p>
)
