...
export const BIO = (
  <p className="text-justify m-0 pt-2.5">
    ...
    Boston Dynamics, working on machine learning and dexterity for Atlas. He earned a Ph.D. 
    from the Robotics Institute at Carnegie Mellon University. His thesis was at the 
